...
function HeroSection() {
  return (
    <div className="bg-[url('/Images/room.jpg')]  h-[100vh] w bg-cover bg-center  flex items-center " id='home'>
      ...
      <h2 className="bg-black/40  text-sm p-6 text-white lg:text-5xl md:text-2xl sm:text-xl">Experience luxury like<span className=" lg:text-5xl md:text3xl sm:text-xl text-sm text-amber-300 ml-2"> Never before</span></h2>
</div>
    </div>
  )
}
